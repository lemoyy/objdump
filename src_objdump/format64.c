/*
** obj.c for obj in /home/noi7/Lab/test/objdump
** 
** Made by thomas
** Login   <noi7@epitech.net>
** 
** Started on  Thu Feb 16 23:47:20 2017 thomas
** Last update Sun Feb 26 12:52:54 2017 thomas
*/
...
static void print_section(char *strtab,
		      Elf64_Ehdr *elf,
		      Elf64_Shdr *shdr,
		      int i)
{
			   ...
			   Elf64_Shdr *shdr)
{
  ...
  while (++i < elf->e_shnum)
	...
	{
	  print_section(strtab, elf, shdr, i);
	}
    }
}
